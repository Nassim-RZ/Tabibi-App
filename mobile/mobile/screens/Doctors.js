...
import { View, Text, StyleSheet, FlatList, TouchableNativeFeedback, SafeAreaView } from 'react-native';
...
function DoctorsScreen() {
    ...
    return (
        <View style={styles.container}>
            <Loader title="Bring doctors" loading={isLoading} />
            ...
            <SafeAreaView style={styles.doctorsListContainer}>
                {doctors.length !== 0 ? (
                    ...
                    />
                ): <Text style={styles.noDoctorsText}>There is no doctors</Text>}
            </SafeAreaView>
        </View>
    )
}
